  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={cn(
          "group/sidebar relative flex h-full w-60 flex-col overflow-y-auto bg-background",
      ...
      >
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <ButtonGroup
            icon={<Icons.settings />}
            label="Configurações"
            // onClick={yourClickHandler2}
            />
          <ButtonGroup
            icon={<Icons.add />}
            label="Nova nota"
            // onClick={yourClickHandler3}
            />
        </div>

        <div className="mt-4">
          <Popover>
            <PopoverTrigger className="mt-4 w-full"></PopoverTrigger>
            <PopoverContent
              className="w-72 p-0"
